...
public class CinemaInitServiceImpl implements ICinemaInitService{
	...
	public void initCinemas() {
		...
		villeRepository.findAll().forEach(v->{
			Stream.of("Megarama","IMAX","Rialto","Walmart").forEach(nameCinema->{
	...
	public void initSalles() {
		...
		cinemaRepository.findAll().forEach(cinema->{
				for(int i=0;i<cinema.getNombreSalles();i++) {
					...
					salle.setNombrePlaces(15+(int)(Math.random()*40));
	...
	public void initSeances() {
		...
		Stream.of("12:00","14:00","16:00","18:00","20:00","22:00").forEach(heure->{
	...
	public void initCategories() {
		Stream.of("Action","Adventure","Animation","Fantasy").forEach(categoryName->{
	...
	public void initFilms() {
		...
		Stream.of("Avengers: Endgame","Toy Story 4 ","The Irishman","Citizen Kane","Get Out","Monlight","Ivana red","Inception").forEach(filmName->{
			Film film = new Film();
	...
	public void initProjections() {
		double[] prices  = new double[] {30,25,40,60,80,110};
